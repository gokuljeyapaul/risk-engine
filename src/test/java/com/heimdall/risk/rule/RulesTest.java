...
public class RulesTest {
	...
	public void testNormalScenarios() {
		...
		final boolean result1 = transactionRules1.isSafeTransaction(info1);
		...
		info1.firstName.set("Casper");
		info1.lastName.set("McFadden");
		info1.amount.set(50.0);

		final TransactionRules transactionRules2 = new TransactionRules();
		final boolean result2 = transactionRules2.isSafeTransaction(info1);
		assertTrue(result2);
		...
		info1.firstName.set("Casper");
		info1.lastName.set("McFadden");
		info1.amount.set(1000.0);

		final TransactionRules transactionRules3 = new TransactionRules();
		final boolean result3 = transactionRules3.isSafeTransaction(info1);
		assertFalse(result3);
	}
	...
	public void testBoundryConditions() {
		...
		final TransactionRules transactionRules2 = new TransactionRules();
		final boolean result2 = transactionRules2.isSafeTransaction(info2);
		assertFalse(result2);
	}
